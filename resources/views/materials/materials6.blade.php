            ...
            <div class="row justify-content-center">
                <div class="col-10">
                    ...
                    <div class="portal-header mb-4">
                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="text-black mb-0 fw-bold">Form 6 Learning Materials</h4>
                                    <p class="text-black-50 mb-0 small">Comprehensive resources for Form 6 students</p>
                                </div>
                            </div>
                            <div>
                            ...
                            <div class="stat-card">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="stat-value">{{ $f6TextBooks->count() }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stat-card">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="stat-value">{{ $f6TextBooks->pluck('category.name')->unique()->count() }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stat-card">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="stat-value">
                                            @php $latest = $f6TextBooks->max('updated_at'); @endphp
                    ...
                    <div class="filter-section mb-4">
                        <div class="d-flex flex-wrap align-items-center gap-3">
                            ...
                            <div class="subject-filters">
                                ...
                                @foreach($f6TextBooks->pluck('category.name')->unique()->filter() as $subject)
                    ...
                    @if($f6TextBooks->count() > 0)
                        <div class="row g-4">
                            @foreach($f6TextBooks as $resource)
