...
<main id="main" class="main">
    ...
    <section class="section students-nav">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Past paper resources</h5>
                    ...
                    <div class="tab-content pt-2" id="myTabjustifiedContent">
                        ...
                        <div class="tab-pane fade show active" id="form1-justified" role="tabpanel" aria-labelledby="form1-tab">
                            <div class="row">
                                @if(count($pastPaper1) > 0)
                                @foreach ($pastPaper1 as $pastPaper )
                                <div class="col-md-4">
                                    <div class="card mb-3">
                                        <div class="row g-0 mt-2">
                                            <div class="col-md-4">
                                                <img src="assets/images/pastpaper.jpeg" class="img-fluid rounded-start" alt="{{ $pastPaper->name }}">
                                            </div>
                                            <div class="col-md-5">
                                                <div class="card-body">
                                                    <h5 class="card-title"> <a href="{{ URL('view-past-paper', $pastPaper->id) }}">{{ $pastPaper->name }}</a></h5>
                                                    <p class="card-text">Form {{ $pastPaper->class_level }}</p>
                                                    <p class="card-text">pastPaper</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-0 mt-2">
                                    <div class="col-md-5">
                                        <div class="card-body">
                                            <p class="card-text">No pastPaper at the moment</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="form2-justified" role="tabpanel" aria-labelledby="form2-tab">
                        <div class="row">
                            @if(count($pastPaper2) > 0)
                            @foreach ($pastPaper2 as $pastPaper )
                            <div class="col-md-4">
                                <div class="card mb-3">
                                    <div class="row g-0 mt-2">
                                        <div class="col-md-4">
                ...
                <div class="tab-pane fade" id="form3-justified" role="tabpanel" aria-labelledby="form3-tab">
                    <div class="row">
                        @if(count($pastPaper3) > 0)
                        @foreach ($pastPaper3 as $pastPaper )
                        <div class="col-md-4">
                            <div class="card mb-3">
                                <div class="row g-0 mt-2">
                                    <div class="col-md-4">
            ...
            <div class="tab-pane fade" id="form4-justified" role="tabpanel" aria-labelledby="form4-tab">
                <div class="row">
                    @if(count($pastPaper4) > 0)
                    @foreach ($pastPaper4 as $pastPaper )
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <div class="row g-0 mt-2">
                                <div class="col-md-4">
        ...
        <div class="tab-pane fade" id="form5-justified" role="tabpanel" aria-labelledby="form5-tab">
            <div class="row">
                <div class="row">
                    @if(count($pastPaper5) > 0)
                    @foreach ($pastPaper5 as $pastPaper )
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <div class="row g-0 mt-2">
                                <div class="col-md-4">
        ...
        <div class="tab-pane fade" id="form6-justified" role="tabpanel" aria-labelledby="form6-tab">
            <div class="row">
                <div class="row">
                    @if(count($pastPaper6) > 0)
                    @foreach ($pastPaper6 as $pastPaper )
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <div class="row g-0 mt-2">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-5">
                                    <div class="card-body">
                                        <h5 class="card-title"> <a href="{{ URL('view-pastPaper', $pastPaper->id) }}">{{ $pastPaper->name }}</a></h5>
                                        <p class="card-text">Form {{ $pastPaper->class_level }}</p>
                                        <p class="card-text">pastPaper</p>
                                    </div>
                                </div>
                    ...
                    <div class="row g-0">
                        <div class="col-md-5">
                            <div class="card-body mt-0">
                                <p class="card-text mt-0">No pastPaper at the moment</p>
                            </div>
                        </div>
                    </div>
                </div>
