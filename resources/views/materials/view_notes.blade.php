...
<main id="main" class="main">
    ...
    <section class="section students-nav">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Notes resources</h5>
                        ...
                        <div class="tab-pane fade show active" id="form1-justified" role="tabpanel" aria-labelledby="form1-tab">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card mb-3">
                                        <div class="row g-0 mt-2">
                                            <div class="col-md-4">
                                                <img src="assets/images/notes.png" class="img-fluid rounded-start" alt="{{ $note->name }}">
                                            </div>
                                            <div class="col-md-5">
                                                <div class="card-body">
                                                    <h5 class="card-title"> <a href="{{ URL('view-note', $note->id) }}">{{ $note->name }}</a></h5>
                                                    <p class="card-text">Form {{ $note->class_level }}</p>
                                ...
                                <div class="row g-0 mt-2">
                                    <div class="col-md-5">
                                        <div class="card-body">
                                            <p class="card-text">No note at the moment</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
