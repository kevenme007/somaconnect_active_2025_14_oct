            ...
            <div class="row justify-content-center">
                <div class="col-10">
                    ...
                    <div class="portal-header mb-4">
                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="text-black mb-0 fw-bold">Form 5 Learning Materials</h4>
                                    <p class="text-black-50 mb-0 small">Comprehensive resources for Form 5 students</p>
                                </div>
                            </div>
                            <div>
                            ...
                            <div class="stat-card">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="stat-value">
                                            @php $latest = $f5TextBooks->max('updated_at'); @endphp
                    ...
                    @if($f5TextBooks->count() > 0)
                        <div class="row g-4">
                            @foreach($f5TextBooks as $resource)
